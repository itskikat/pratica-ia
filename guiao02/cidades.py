...
class Cidades(SearchDomain):
    ...
    # dado um estado e uma acao, devolve o respectivo custo de executar essa acao nesse estado
    # para uma acao (C1,C2), correspondente a uma deslocacao de C1 para C2, o custo devera ser a distancia entre as cidades.
    ...
    def heuristic(self, city, goal_city):
        ...
        heuristic = math.hypot(x1-x2, y1-y2)
        return heuristic
